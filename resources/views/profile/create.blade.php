        ...
        <div class="col-lg-12">
            ...
            <div class="card-body">
                <form class="user" >
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            <label for="" class="small font-weight-bold">Address</label>
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="text" class="form-control form-control-user" id="exampleInputEmail" name="phone" v-model="phone">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-sm-0">
                            <label for="" class="small font-weight-bold">Emergency Name</label>
